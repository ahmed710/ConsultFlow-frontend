...
import { NgbModal, NgbModalConfig, NgbOffcanvas, NgbModule, NgbDropdownModule } from '@ng-bootstrap/ng-bootstrap';
...
@Component({
  ...
  imports: [SharedModule, CommonModule, NgbModule, NgbDropdownModule, SpkDropdowns, SpkReusableTables, SpkApexChart],
...
Folders: Folder[] = [
  { name: "Project_Files", fileCount: 246, size: "214.32MB",important:"" },
  { name: "Client_Documents", fileCount: 17, size: "432.39KB", important: "true" },
  { name: "Marketing_Materials", fileCount: 437, size: "3.12GB", important: "true" },
];
CountriesHeader = [
  {header:'File Name'},
  {header:'Category'},
...
FileData: FileItem[] = [
  {
    ...
    avatarClass: "svg-primary text-primary",
  ...
  },
  {
    ...
    avatarClass: "svg-secondary text-secondary",
  ...
  },
  {
    ...
    avatarClass: "svg-success text-success",
  ...
  },
  {
    ...
    avatarClass: "svg-orange text-orange",
  ...
  },
  {
    ...
    avatarClass: "svg-info text-info",
