...
@Component({
  selector: 'app-hrm',
  standalone: true,
  imports: [NgbModule, SharedModule, CommonModule, SpkHrmCard, SpkApexChart, SpkDropdowns, SpkReusableTables],
...
export class Hrm {
  Hrmcards: CardData[] = [
    ...
    },
    {
        ...
        percent: "1.86%",
        year: "This Year",
        svgIcon: '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#5f6368"><path d="M0 0h24v24H0z" fill="none"></path><path d="M15 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm-9-2V7H4v3H1v2h3v3h2v-3h3v-2H6zm9 4c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"></path></svg>',
        svgColor: "secondary",
    ...
    },
    {
        ...
        percent: "3.09%",
        year: "This Year",
        svgIcon: '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#5f6368"><path d="M0 0h24v24H0zm10 5h4v2h-4zm0 0h4v2h-4z" fill="none"></path><path d="M10 16v-1H3.01L3 19c0 1.11.89 2 2 2h14c1.11 0 2-.89 2-2v-4h-7v1h-4zm10-9h-4.01V5l-2-2h-4l-2 2v2H4c-1.1 0-2 .9-2 2v3c0 1.11.89 2 2 2h6v-2h4v2h6c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zm-6 0h-4V5h4v2z"></path></svg>',
        svgColor: "success",
    ...
    },
    {
        ...
        percent: "0.97%",
        year: "This Year",
        svgIcon:'<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#5f6368"><g><rect fill="none" height="24" width="24"></rect></g><g><path d="M14,8c0-2.21-1.79-4-4-4S6,5.79,6,8s1.79,4,4,4S14,10.21,14,8z M17,10v2h6v-2H17z M2,18v2h16v-2c0-2.66-5.33-4-8-4 S2,15.34,2,18z"></path></g></svg>',
        svgColor: "warning",
...
EmployeesStatus=[
  { type: 'Remote', count: "4,075", className: 'remote' },
  { type: 'Probation', count: "5,775", className: 'probation' },
  { type: 'Contract', count: "3,976", className: 'contract' },
  { type: 'Work From Home', count: "1,675", className: 'work-home' },
]
AttendanceHeader=[
  {header:'Name'},
  {header:'Time In'},
